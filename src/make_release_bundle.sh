...
INTERV="resynth_vocos resynth_glvocos resynth_griffinlim resynth_hift3 resynth_s3vc3 resynth_glc3 resynth_hiftcb resynth_s3vccb resynth_glcb resynth_bigvgan resynth_encodec resynth_dac"
...
RES=$(git ls-files results/final 2>/dev/null || ls results/final/*)
