...
| §4.2 same-mel decoder swap (D_G, D_ΔP, D_T) and the exploratory cross-mel Griffin–Lim table | `gen/resynth_gl_samemel.py`, `analyze_decoder_swap.py` | `decoder_swap_wavlm_L0.csv`, `decoder_swap_wavlm_tn_L0.csv`, `gl_crossmel_wavlm_L0.csv` |
...
```
577309d99a74d00fe8d9489da2a39fde9d144ac749a9879b0ac6a625d0165bdf  audio_generated.tar  (3.14 GB)
...
5ef3c4ccf418f76a5dfff7bc2386c008cf786763152cce349d502dc8051a849b  manifests_and_results.tar  (5.6 MB)
```
